...
SUPABASE_URL = "https://jyqnlsffldwnipgzktqd.supabase.co" # Replace with your Supabase URL
SUPABASE_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imp5cW5sc2ZmbGR3bmlwZ3prdHFkIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc2OTA3MTk5MywiZXhwIjoyMDg0NjQ3OTkzfQ.4nvricp-_N2YRYA-C-KLfstOsCduRUMsFfzYmn1RiVY" # Replace with your Supabase API key

supabase: Client = create_client(SUPABASE_URL, SUPABASE_KEY)

bucket_name = "image1" # Name of the bucket to be created
image_path = "PES1UG23CS917.jpeg"  # Replace with the local image path
image_name = "PES1UG23CS917.jpeg"  # Desired name for the uploaded file
